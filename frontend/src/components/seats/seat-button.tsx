...
export function SeatButton({
  ...
  return (
    <button
      ...
      className={cn(
        "relative flex h-9 w-8 items-center justify-center rounded-lg border text-[10px] font-semibold transition-all duration-200 active:scale-95 md:h-10 md:w-9",
